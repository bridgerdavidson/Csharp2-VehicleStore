...
namespace VehicleClassLibrary2._2.Models
{
    ...
    internal class MotorcycleModel : VehicleModel
    {
        ...
        public MotorcycleModel(int id, string make, string model, int year, decimal price, int numOfWheels, bool hasSideCar, decimal seatHeight) : base(id, make, model, year, price, numOfWheels)
        {
        ...
        public override string ToString()
        {
            ...
            return $"{Id}: {Year} {Make} {Model} with {NumOfWheels} and a {SeatHeight} inch tall seat {sideCar} a side car - {Price:C2}";
        }
